...
Diese Perspektive verdeutlicht, dass Musik Emotionen nicht über einen einheitlichen Weise hervorruft, sondern über mehrere auch teilweise parallel ablaufend.
...
Musik ist im sportlichen Kontext häufig nicht nur Begleitphänomen, kann gezielt als Mittel zur Beeinflussung emotionaler Zustände eingesetzt. Emotionale Reaktionen wie Freude, Aktivierung oder reduzierte Anspannung gelten dabei als zentrale Wirkmechanismen, über die Musik indirekt sportliche Leistung beeinflussen kann. Die empirische Forschung zeigt, dass Musik im sportlichen Kontext vor allem emotionale und erlebensbezogene Prozesse beeinflusst, während Effekte auf kognitive Leistungsaspekte eine geringe Rolle spielen @kampfe2011impact.

Eine Analyse von Kämpfe, Sedlmeier und Renkewitz untersuchte die Effekte von Hintergrundmusik auf verhaltensbezogene, kognitive und emotionale Parameter, und sind damit auch für bewegungs- und leistungsbezogene Aktivitäten relevant @kampfe2011impact. Die Ergebnisse deuten darauf hin, dass Musik im Vergleich zu einer ähnlichen Situation ohne Musik einen kleinen, aber konsistent positiven Effekt auf emotionale Reaktionen während sportlicher Betätigung besitzt.Insbesondere Merkmale wie positive Stimmung, erhöhte Freude an der Aktivität und eine geringere wahrgenommene Monotonie wurden durch musikalische Begleitung begünstigt @kampfe2011impact.

Im Gegensatz zu kognitiven Aufgaben, bei denen Musik häufig als störend beschrieben wird, scheint sportliche Aktivität empfänglich für positive emotionale Beeinflussungen durch Musik zu sein.
...
Die Meta-Analyse von Kämpfe et al. zeigt, dass Musik im Kontext von Aufgaben und Aktivitäten vor allem affektive Prozesse beeinflusst, während kognitive Prozesse vergleichsweise wenig verändert werden. Dadurch kann Musik das subjektive Erleben von Belastung positiv beeinflussen, ohne die Aufgabenausführung wesentlich zu beeinträchtigen. @kampfe2011impact
