...
Ergänzend wird in der neueren musikpsychologischen Forschung betont, dass emotionale Reaktionen auf Musik über unterschiedliche zugrunde liegende Mechanismen vermittelt werden können. Juslin und Västfjäll unterscheiden unter anderem automatische, physiologisch verankerte Reaktionen von stärker kognitiv vermittelten Prozessen, etwa solchen, die auf emotionaler Ansteckung oder Erwartungsbildung beruhen @juslin2008emotional[S. 559-562]. Diese Perspektive verdeutlicht, dass Musik Emotionen nicht über einen einheitlichen Wirkweg hervorruft, sondern über mehrere, teilweise parallel ablaufende Prozesse.
